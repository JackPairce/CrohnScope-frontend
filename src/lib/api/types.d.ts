...
export interface paths {
  ...
  "/masks/regions": {
    ...
    /**
     * Mask2Regions
     * @description Convert a mask to regions.
     *
     *     Args:
     *         mask: Mask array of shape (H, W) with region labels
     *
     *     Returns:
     *         MaskArray: Array of unique region labels in the mask
     */
    post: operations["mask2regions_masks_regions_post"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface operations {
  ...
  mask2regions_masks_regions_post: {
    parameters: {
      query?: never;
      header?: never;
      path?: never;
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["MaskArray"];
      };
    };
    responses: {
      /** @description Successful Response */

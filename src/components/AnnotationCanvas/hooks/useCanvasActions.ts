...
import { DataProcessingMode, SaveSatues } from "../types";
...
export class CanvasActionsHandler {
  ...
  private which: DataProcessingMode;
  ...
  async markCurrentMask() {
    ...
    try {
      ...
      console.log("Marking mask as done:", this.callbacks);
      ...
      if (this.callbacks.onMarkComplete) {
        ...
        await setMaskDone(
          currentTab.mask_id,
          this.which === "segmentation" ? "segmentation" : "annotation"
        );
      }

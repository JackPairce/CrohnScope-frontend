...
const dataSections = [
  { name: "Management", path: "/data/management", icon: "/svgs/dataset.svg" },
  { name: "Segmentation", path: "/data/segmentation", icon: "/svgs/brush.svg" },
  { name: "Labeling", path: "/data/labeling", icon: "/svgs/checkmark.svg" },
  { name: "Diagnostics", path: "/data/diagnostics", icon: "/svgs/chart.svg" },
];
    ...
    <header className="flex items-center justify-between p-4 border-b shadow-sm">
      <div className="flex items-center gap-4">
        <div className="flex items-center">
          ...
          <Link
            href="/data"
            className="flex items-center gap-2 px-2 py-1 text-sm hover:bg-gray-100 rounded text-gray-800 transition-colors"
          >
            <span>Data Hub</span>
          </Link>
      ...
      <div className="flex items-center gap-6">
        ...
        <div className="relative">
          ...
          {isProfileOpen && (
            <div
              ref={dropdownRef}
              className="absolute right-0 mt-2 w-64 bg-white rounded-md shadow-lg border border-gray-200 z-10 header-dropdown-animation"
            >

...
export default function ClassificationCanvas({
  ...
  return (
    <QueryClientProvider client={queryClient.current}>
      <ClassificationWorkspace image={image} />
    </QueryClientProvider>
  );
}

function ClassificationWorkspace({ image }: { image: ApiImage }) {
  ...
  console.log(
    ["all", "healthy"].includes(layerState as string),
    ["all", "unhealthy"].includes(layerState as string)
  );
